...
INSERT INTO RECETTE (categorie, auteur, nom, description, lien_image, lien_video, temps_preparation, temps_cuisson, note, nb_personnes)
VALUES ('Plat', 'Mich', 'Blanquette de Veau', 'Une délicieuse blanquette accompagnée de champignons et de carottes.',
        ...
        'https://www.youtube.com/watch?v=fW2flBSkv1M&ab_channel=Rujay', '15', '75', '9/10', 4),
       ...
       ('Plat', 'Mich', 'Spaghetti bolognaise',
        ...
        'https://www.youtube.com/watch?v=fW2flBSkv1M&ab_channel=Rujay', '15', '15', '7.5/10', 4),
       ...
       ('Plat', 'Mich', 'Riz et cordon bleu', 'La recette de la dèche, incroyablement succulent mais un peu sec.',
        ...
        'https://www.youtube.com/watch?v=fW2flBSkv1M&ab_channel=Rujay', '5', '20', '6/10', 4),

       ('Plat', 'Mich', 'Banh cuong', 'La meilleure des crêpes, elle est vietnamienne.',
        'https://i.imgur.com/5CkZQsL.jpg',
        'https://www.youtube.com/watch?v=fW2flBSkv1M&ab_channel=Rujay', '60', '15', '9/10', 4),
       ...
       ('Entrée', 'Mich', 'Tomates mozarella',
        ...
        'https://www.youtube.com/watch?v=fW2flBSkv1M&ab_channel=Rujay', '60', '0', '9/10', 4);
